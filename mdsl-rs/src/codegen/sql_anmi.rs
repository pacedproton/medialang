...
impl AnmiSqlGenerator {
    ...
    fn generate_anmi_schema(&self) -> Result<String> {
        ...
        sql.push_str("    id_mo INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n");
        ...
        sql.push_str("    id_source INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n");
        sql.push_str("    source_name VARCHAR(100)\n");
        sql.push_str(");\n\n");

        // sectors table (for vocabulary)
        sql.push_str("CREATE TABLE IF NOT EXISTS graphv3.sectors (\n");
        sql.push_str("    id_sector INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n");
        ...
        sql.push_str("    id_area INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n");
